...
const HeroSection = () => {
  return (
    <div className="w-[70%] mt-[10%] text-center ">

    <h1 className="text-7xl">
      Marketing done <div className=" rounded-full easy inline-block px-2 py-1 text-4xl">easy</div><br /> As always
  
    </h1>
    <p className='mt-5 secondary-font text-[1rem] mb-7'>
